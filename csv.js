...
//  var query = client.query('CREATE TABLE yonew ( date VARCHAR(100) ,issue VARCHAR(100),company VARCHAR(100) ,state VARCHAR(40) , zip VARCHAR(100) ,cid SERIAL PRIMARY KEY not null )');
//  var query = client.query("INSERT INTO final ( date, issue, company, state, zip, cid) values($1, $2, $3, $4, $5, $6)", [arr1[0],arr1[1],arr1[2],arr1[3],arr1[4],arr1[5]]);
